...
# from ar_utils import first_to_lastpad,get_real_src,get_real_encoderout
...
class IterativeRefinementGenerator(object):
    ...
    def generate(self, models, sample, prefix_tokens=None, constraints=None):
        ...
        def is_a_loop(x, y, s, a):
            ...
            return (x == y).all(1), y, s, a  #给x和y增加padding
        ...
        for step in range(self.max_iter + 1):
            ...
            decoder_out = model.forward_decoder(prev_decoder_out, encoder_out, src_tokens,**decoder_options)
